...
export type NoDoFluxo = Node<DadosDoNo, "elo">;

export function EloNode({ data, selected }: NodeProps<NoDoFluxo>) {
  ...
  return (
    ...
    >
      ...
      {/* Sem botões, a saída é única e sai por baixo. */}
      {!temBotoes && (
        <Handle
          type="source"
...
export const NODE_TYPES = { elo: EloNode };
